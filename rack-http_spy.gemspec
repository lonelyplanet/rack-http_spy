...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Middleware for profiling garbage collection in Rack-compatible apps}
  spec.description   = %q{Middleware for profiling garbage collection in Rack-compatible apps}
